...
.wp-trv__grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(400px, 1fr)); gap: var(--wp-space-6); }
.wp-trv__var {
...
.wp-trv__row {
  display: grid; grid-template-columns: minmax(0, 2.2fr) minmax(64px, 1fr) 48px;
